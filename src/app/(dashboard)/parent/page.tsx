...
const ParentPage = async () => {
  ...
  // البحث عن الطلاب بناءً على اسم ولي الأمر (guardianName)
  // ملاحظة: هذا يتطلب أن يكون اسم ولي الأمر مطابقاً لاسم المستخدم
            ...
            <div className="h-full bg-white p-4 rounded-md">
              ...
              <div className="mt-4">
                <p className="text-gray-600 mb-4">
                  {student.fullName} - {student.specialization || 'بدون تخصص'}
                </p>
