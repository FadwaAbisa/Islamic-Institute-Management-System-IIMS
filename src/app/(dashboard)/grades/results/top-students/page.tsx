        ...
        <Card className="bg-white border-lamaYellowLight shadow-lg mb-8">
          <CardContent className="p-8">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              {/* Number of Students */}
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700 block text-center font-tajawal">عدد الطلاب المطلوبة</label>
                <Input
                  type="number"
                  value={numberOfStudents}
                  onChange={(e) => setNumberOfStudents(e.target.value)}
                  className="text-center border-lamaYellowLight focus:border-lamaYellow focus:ring-lamaYellow font-tajawal"
                  placeholder="1"
                />
              </div>
            </div>
