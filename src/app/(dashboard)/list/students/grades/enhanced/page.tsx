                ...
                <Card className="modern-card">
                    <CardContent className="p-0">
                        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                            <TabsList className="grid w-full grid-cols-2 bg-white/80 shadow-xl rounded-t-3xl p-3" dir="rtl">
                                <TabsTrigger
                                    value="grades-management"
                                    className="data-[state=active]:bg-gradient-to-l data-[state=active]:from-lama-sky data-[state=active]:to-lama-yellow data-[state=active]:text-white rounded-2xl text-lg py-4 font-semibold"
                                >
