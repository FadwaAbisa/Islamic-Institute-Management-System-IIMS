...
const ConversationWorkingPage = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (response.ok) {
        // إضافة الرسالة محلياً للتجربة السريعة
          ...
          <div className="flex items-center gap-3 flex-1">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="bg-blue-100 text-blue-800 text-xs px-2 py-0.5 rounded-full">تجريبي</span>
              </div>
            </div>
          </div>
        </div>
...
export default ConversationWorkingPage;
